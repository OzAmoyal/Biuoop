...
//otherwise return false
    ...
    public Point intersectionWith(Line other) {
        ...
        if (this.slope == null) {
            ...
            //for y multiplie the x value of the vertical line with the slope of the second, add b to the y coordinate.
     ...
     * @return the closest intersection point to the start of the line or null if there is no Point.
     */
